...
export function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md border-black/10 dark:border-white/20 bg-white/70 dark:bg-white/10 backdrop-blur-xl">
      <CardHeader>
        <CardTitle className="text-center text-2xl font-heading">تسجيل الدخول</CardTitle>
      </CardHeader>
      <CardContent>
        <form action={action} className="space-y-4">
          ...
          <p className="text-center text-sm mt-4 opacity-70">
            ليس لديك حساب؟ <Link href="/signup" className="text-blue-600 font-bold hover:underline">إنشاء حساب جديد</Link>
          </p>
        </form>
      </CardContent>
    </Card>
